...
## Line 70
## At line 260, back over to this script

saveRDS(quarter, paste0(old_path, 
                        "/aaa_extract_", year, month, ".rds"))


#### 2_checking_extracts.R ####
#### 2: Call in extract ----
quarter <- read_rds(paste0(old_path, "/aaa_extract_202206.rds")) %>% 
